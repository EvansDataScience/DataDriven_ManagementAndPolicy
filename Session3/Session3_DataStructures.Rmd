...
As you see above, the presence of "40"  as an element, *coerced* the other values to *characters* (the _numbers_ are now _text_, the symbol **''** is used to show that). Updating that value, will not change the vector type:
...
The function _length_ works for vectors and lists telling the amount of elements. In data frames, it gives you number of columns, NOT rows. 
