...
* Using **str()**, verify if there is a numeric value that has been read as text. If so, please modify it. If there were several, do not use more than three.
* Identify if there are weird values in the numeric columns (now all re formatted). If there were several, do not use more than three.
